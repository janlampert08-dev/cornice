...
// app/profil/premium/page.tsx und components/PremiumCard.tsx. Die
// zugrunde liegende Stripe-Integration (lib/actions/billing.ts,
// lib/stripeClient.ts, app/api/stripe/webhook/) bleibt unangetastet, damit
// das Feature bei Bedarf ohne Backend-Änderungen reaktiviert werden kann.
//
// "use client";
//
