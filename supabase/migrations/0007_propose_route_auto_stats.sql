-- Ergänzt propose_route_full um automatisch berechnete Höhe, Steigung und
-- Kehrenzahl (Client ermittelt sie über swisstopo-Höhenprofil + Peilungs-
-- analyse, siehe lib/elevation.ts, und übergibt sie fertig berechnet).
...
begin
  ...
  insert into public.routes (
    ...
    tempolimits, hoehe_m, max_steigung_prozent, kehren, erstellt_von
  ) values (
    ...
    p_tempolimits, p_hoehe_m, p_max_steigung_prozent, p_kehren, auth.uid()
  )
